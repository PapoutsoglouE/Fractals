...
public class Mandelbrot {
	 ...
	 */
	public Mandelbrot(int width, int height, double zoomIn, int max_iter, int horCenter, int verCenter, int colorShift) throws IOException {
		/* 
		...
		File pixel_values = new File("out.txt"); //Create path to output file.
	...
	public static void main(String[] args) throws IOException {
		...
		new Mandelbrot(width, height, zoom, iter, horCenter, verCenter, colShift);
